...
####
PROJECT_CARES_WITH_DISABLED_APPS="${MY_PROJECT_CARES_WITH_DISABLED_APPS:=OFF}"
PROJECT_CARES_WITH_DISABLED_TEST_APPS="${MY_PROJECT_CARES_WITH_DISABLED_TEST_APPS:=OFF}"
...
if [ "ON" = "$PROJECT_CARES_WITH_DISABLED_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCARES_WITH_DISABLED_APPS=$PROJECT_CARES_WITH_DISABLED_APPS")
fi
if [ "ON" = "$PROJECT_CARES_WITH_DISABLED_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCARES_WITH_DISABLED_TEST_APPS=$PROJECT_CARES_WITH_DISABLED_TEST_APPS")
fi
